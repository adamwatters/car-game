...
@onready var car = $car_parent/car
@onready var car_mesh = $car_parent/car_mesh
@onready var car_mesh_inner = $car_parent/car_mesh/car_mesh_inner
@onready var car_body = $car_parent/car_mesh/car_mesh_inner/ambulance/body
@onready var car_wheel_left = $car_parent/car_mesh/car_mesh_inner/ambulance/wheel_frontLeft
@onready var car_wheel_right = $car_parent/car_mesh/car_mesh_inner/ambulance/wheel_frontRight
@onready var ground_ray = $car_parent/car_mesh/car_mesh_inner/ground_ray
...
func _physics_process(delta):
	...
	var look_at_target = car_mesh.global_position + car.linear_velocity.normalized()
	var y_offset = 0
	if is_on_ground:
		y_offset = ground_normal_angle * clamp(car.linear_velocity.y, -1, 1)
		...
		look_at_target_y_offset = lerpf(look_at_target_y_offset, y_offset, delta * 2)
